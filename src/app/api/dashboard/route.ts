...
// Next.js can safely serialize plain object arguments for unstable_cache.
// Passing a pre-serialized JSON string and parsing it again caused malformed
// cache arguments in production after deployment, which broke SDR Analytics
// and Marita Workspace with a JSON.parse error.
