...
if [ -n "$DEPLOY_HUBSPOT_PRIVATE_APP_TOKEN" ]; then HUBSPOT_PRIVATE_APP_TOKEN="$DEPLOY_HUBSPOT_PRIVATE_APP_TOKEN"; fi
if [ -n "$DEPLOY_MAQSAM_INGEST_SECRET" ]; then MAQSAM_INGEST_SECRET="$DEPLOY_MAQSAM_INGEST_SECRET"; fi
if [ -n "$DEPLOY_MAQSAM_BASIC_AUTH" ]; then MAQSAM_BASIC_AUTH="$DEPLOY_MAQSAM_BASIC_AUTH"; fi
if [ -n "$DEPLOY_MAQSAM_ACCESS_KEY" ]; then MAQSAM_ACCESS_KEY="$DEPLOY_MAQSAM_ACCESS_KEY"; fi
if [ -n "$DEPLOY_MAQSAM_ACCESS_SECRET" ]; then MAQSAM_ACCESS_SECRET="$DEPLOY_MAQSAM_ACCESS_SECRET"; fi
if [ -n "$DEPLOY_MAQSAM_TARGET_AGENT_EMAIL" ]; then MAQSAM_TARGET_AGENT_EMAIL="$DEPLOY_MAQSAM_TARGET_AGENT_EMAIL"; fi
if [ -n "$DEPLOY_MAQSAM_SYNC_INTERVAL_SECONDS" ]; then MAQSAM_SYNC_INTERVAL_SECONDS="$DEPLOY_MAQSAM_SYNC_INTERVAL_SECONDS"; fi
if [ -n "$DEPLOY_MAQSAM_SYNC_LOOKBACK_SECONDS" ]; then MAQSAM_SYNC_LOOKBACK_SECONDS="$DEPLOY_MAQSAM_SYNC_LOOKBACK_SECONDS"; fi
if [ -n "$DEPLOY_MAQSAM_SYNC_PAGE_COUNT" ]; then MAQSAM_SYNC_PAGE_COUNT="$DEPLOY_MAQSAM_SYNC_PAGE_COUNT"; fi
